...
ActiveRecord::Schema[8.0].define(version: 2025_09_10_155339) do
  create_table "chore_trackers", force: :cascade do |t|
    ...
    t.index ["chore_id"], name: "index_chore_trackers_on_chore_id"
    t.index ["doer_id"], name: "index_chore_trackers_on_doer_id"
    t.index ["user_id"], name: "index_chore_trackers_on_user_id"
  end
